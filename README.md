...
2) Разместите файлы с приложением (app.py) в одной директории вместе с предобученной моделью catboost_model.cbm (можно скачать по ссылке [Google Drive](https://drive.google.com/file/d/1iCJ8kFu1sJzFSZvovXC24TpYxcoJlln4/view?usp=sharing) весит > 25 мб)
